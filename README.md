...
- [x] Then it'll (optionally) change the HTML code @ `.filterHTML(..)`;
- [x] Also it'll (optionally) convert some of the **special syntax** to 'nice looking' code/text @ `.filterSpecial(..)`;
